                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextFormField(
                      ...
                      onSubmit: (_) {},
                      validator: ValidationBuilder(localeName: c.state.lang).email().minLength(10).maxLength(50).build(),
                      inputFormatters: [
                    ...
                    CustomTextFormField(
                      ...
                      onSubmit: (value) => (c.state.formKey.currentState?.validate() == true) ? c.doLogin(context) : null,
                    ),
                    Container(
                    ...
                    CustomFilledButton(
                      ...
                      title: 'Masuk'.tr,
                      onPressed: () async {
                        if (c.state.formKey.currentState?.validate() == true) c.doLogin(context);
                      },
                    ),
                    // CustomFilledButton(
