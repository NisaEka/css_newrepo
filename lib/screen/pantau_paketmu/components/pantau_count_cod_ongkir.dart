...
//
// class PantauCountCodOngkir extends StatelessWidget {
//   final String title;
//
//   const PantauCountCodOngkir({super.key, required this.title});
//
//   @override
...
//           controller.state.selectedTipeKiriman.value = 'cod ongkir';
...
//               ),
//
//               // COD Ongkir Value Section with Flexible Layout
//               Container(
...
//                   title: 'COD Ongkir'.tr,
//                   value:
//                       'Rp ${codOngkirAmount.toInt().toCurrency()} ${title != "Total Kiriman" ? '($codOngkirAmountPercentage%)' : ''}',
//                   isHorizontal: true,
//                   isHasSpace: true,
