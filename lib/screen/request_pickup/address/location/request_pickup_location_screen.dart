...
//   }
//
//   Widget _bodyContent(BuildContext context, RequestPickupLocationController controller) {
...
//
//     final CameraPosition kGooglePlex = CameraPosition(target: LatLng(controller.selectedLat, controller.selectedLng), zoom: 16.0);
//
//     return Container(
//       width: Get.width,
//       height: Get.width / 2,
...
//             },
//             onCameraMove: (CameraPosition position) => controller.onCameraMove(position.target),
...
//   }
//
//   Widget _searchBar(BuildContext context, RequestPickupLocationController controller) {
//     return TextField(
...
//         enabledBorder:
//             const OutlineInputBorder(borderSide: BorderSide(color: Colors.grey, width: 1), borderRadius: BorderRadius.all(Radius.circular(16))),
