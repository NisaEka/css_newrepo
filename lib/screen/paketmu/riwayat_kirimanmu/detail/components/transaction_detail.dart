                    ...
                    child: Column(
                      ...
                      children: [
                        CustomLabelText(
                          ...
                          value: c.state.transactionModel?.createdDateSearch
                      ...
                      ? Get.to(const LabelScreen(), arguments: {
                          'data': DataTransactionModel(
                            destination: Destination(
                              destinationCode:
                                  c.state.transactionModel?.destinationCode,
                              zipCode: c.state.transactionModel?.receiverZip,
                              cityName: c.state.transactionModel?.receiverCity,
                              countryName:
                                  c.state.transactionModel?.receiverCountry,
                              districtName:
                                  c.state.transactionModel?.receiverDistrict,
                              provinceName:
                                  c.state.transactionModel?.receiverRegion,
                              subdistrictName:
                                  c.state.transactionModel?.receiverSubdistrict,
                            ),
                            ...
                            receiver: ReceiverModel(
                                ...
                                destinationDescription:
                                    c.state.transactionModel?.destinationDesc,
                                city: c.state.transactionModel?.receiverCity,
                                country:
                                    c.state.transactionModel?.receiverCountry,
                                contact:
                                    c.state.transactionModel?.receiverContact,
                                ...
                                district:
                                    c.state.transactionModel?.receiverDistrict,
                                subDistrict: c.state.transactionModel
                                    ?.receiverSubdistrict),
                            shipper: ShipperModel(
                              ...
                              origin: OriginModel(
                                originCode:
                                    c.state.transactionModel?.originCode,
                                originName:
                                    c.state.transactionModel?.originDesc,
                            ...
                            registrationId:
                                c.state.transactionModel?.registrationId,
                            status: c.state.transactionModel?.statusAwb,
                            createdDate:
                                c.state.transactionModel?.createdDateSearch,
                            ...
                            delivery: Delivery(
                                serviceCode:
                                    c.state.transactionModel?.serviceCode,
                                insuranceFlag:
                                    c.state.transactionModel?.insuranceFlag,
                                ...
                                flatRate:
                                    c.state.transactionModel?.deliveryPrice,
                                freightCharge:
                                    c.state.transactionModel?.deliveryPrice,
                                specialInstruction:
                                    c.state.transactionModel?.specialIns,
                                woodPackaging:
                                    c.state.transactionModel?.packingkayuFlag,
                                flatRateWithInsurance:
                                    c.state.transactionModel?.insuranceAmount,
