                          ...
                          children: [
                            ...
                            c.state.isOnline && c.isSaveReceiver()
                                ? CustomFilledButton(
                                    ...
                                    borderColor: c.state.formKey.currentState?.validate() == true ? blueJNE : greyColor,
                                    fontColor: c.state.formKey.currentState?.validate() == true ? blueJNE : greyColor,
                                    onPressed: () => c.state.formKey.currentState?.validate() == true ? c.saveReceiver() : null,
                                  )
                                : const SizedBox(),
                            CustomFilledButton(
                              color: c.state.formKey.currentState?.validate() == true ? blueJNE : greyColor,
                              title: "Selanjutnya".tr,
                              onPressed: () => c.state.formKey.currentState?.validate() == true ? c.nextStep() : null,
                            )
                          ],
                        ),
                      ),
