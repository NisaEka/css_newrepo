                          ...
                          children: [
                            ...
                            c.state.isOnline && c.isSaveReceiver()
                                ? CustomFilledButton(
                                    ...
                                    borderColor: (c.state.formKey.currentState?.validate() == true || c.state.isValidate) ? blueJNE : greyColor,
                                    fontColor: c.state.formKey.currentState?.validate() == true || c.state.isValidate ? blueJNE : greyColor,
                                    onPressed: () => c.state.formKey.currentState?.validate() == true || c.state.isValidate ? c.saveReceiver() : null,
                                  )
                                : const SizedBox(),
                            CustomFilledButton(
                              color: c.state.formKey.currentState?.validate() == true || c.state.isValidate ? blueJNE : greyColor,
