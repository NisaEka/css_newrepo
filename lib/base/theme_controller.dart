  ...
  ThemeData light() {
    return ThemeData(
      ...
      colorScheme: const ColorScheme.light(
          primary: blueJNE, secondary: greyLightColor2, background: whiteColor, onPrimary: blueJNE, onBackground: whiteColor, outline: greyColor),
      ...
      filledButtonTheme: FilledButtonThemeData(style: ButtonStyle(backgroundColor: MaterialStateProperty.all(blueJNE))),
    );
  }
