...
class RequestPickupImpl extends RequestPickupRepository {
  ...
  Future<DefaultResponseModel<List<RequestPickupModel>>> getRequestPickups(
      RequestPickupFilterModel filter) async {
    try {
      var response = await network.dio
          .get("/transaction/pickup", queryParameters: filter.toJson());
  ...
  Future<DefaultResponseModel<String>> createRequestPickup(
    ...
    try {
      var response = await network.dio
          .post('/transaction/pickup', data: createRequest.toJson());
  ...
  Future<DefaultResponseModel<String>> createRequestPickupAddress(
    ...
    try {
      var response = await network.dio
          .post('/transaction/pickup/address', data: createRequest.toJson());
      return DefaultResponseModel.fromJson(response.data, '');
    } on DioException catch (e) {
      return DefaultResponseModel.fromJson(e.response?.data, '');
    }
  ...
  Future<DefaultResponseModel<List<RequestPickupAddressModel>>>
      getRequestPickupAddresses() async {
    try {
  ...
  Future<DefaultResponseModel<RequestPickupDetailModel>> getRequestPickupByAwb(
    ...
    try {
      ...
      RequestPickupDetailModel payload =
          RequestPickupDetailModel.fromJson(response.data['payload']);
  ...
  Future<DefaultResponseModel<List<String>>> getRequestPickupCities(
      DefaultPageFilterModel filterModel) async {
    try {
      var response = await network.dio.get('/transaction/pickup/city',
