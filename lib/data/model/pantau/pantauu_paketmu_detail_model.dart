...
class PantauuPaketmuDetailModel {
  String awbNo;
  ...
  // Factory constructor
  factory PantauuPaketmuDetailModel.fromJson(Map<String, dynamic> json) {
    return PantauuPaketmuDetailModel(
      awbNo: json['awbNo'] ?? '',
