class GetCcrfActivityModel {
  GetCcrfActivityModel({
    num? code,
    String? message,
    List<CcrfActivityModel>? payload,
  }) {
    _code = code;
    _message = message;
    _payload = payload;
  ...
  GetCcrfActivityModel.fromJson(dynamic json) {
    _code = json['code'];
    _message = json['message'];
    if (json['payload'] != null) {
      _payload = [];
      json['payload'].forEach((v) {
        _payload?.add(CcrfActivityModel.fromJson(v));
      });
    }
  }
  ...
  num? _code;
  String? _message;
  List<CcrfActivityModel>? _payload;

  GetCcrfActivityModel copyWith({
    num? code,
    String? message,
    List<CcrfActivityModel>? payload,
  }) =>
  ...
  List<CcrfActivityModel>? get payload => _payload;
