class LanguageID {
  static Map<String, String> getLanguage() {
    return {
      ...
      "kerahasiaan_data": "Informasi ini rahasia, hanya kamu yang dapat melihatnya dan tidak dibagikan ke pihak manapun",
      ...
      "Internal server error" : "Gagal terhubung ke server, silakan coba lagi nanti"
    };
  }
}
