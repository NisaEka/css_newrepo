class LanguageEN {
  static Map<String, String> getLanguage() {
    return {
      ...
      "Mohon masukkan lima digit terakhir nomor telepon pengirim atau penerima":
      ...
      "Nomor telepon harus diawali dengan 0 atau 62":
          "Phone number must start with 0 or 62",
